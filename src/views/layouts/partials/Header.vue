                            ...
                            <Menu as="div" class="relative ml-3">
                                ...
                                >
                                    <MenuItems
                                        ...
                                        scroll-m-8 hover:scroll-m-0  ring-black ring-opacity-5 focus:outline-none h-80 min-h-full
                                        divide-y divide-slate-400/20"
                                    >
                                        <div class="flex items-center py-2.5 px-3.5 justify-between">
                                            <span class="font-semibold text-slate-900 dark:text-slate-200">
                                                All notifications
                                                <span class="mb-1.5 text-[0.6875rem] text-slate-500 block">
                                            ...
                                            <Menu as="div" class="relative inline-block text-left">
                                                <div>
                                                    <MenuButton class="font-semibold text-slate-900 dark:text-slate-200">
                                                    ...
                                                    <MenuItems class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                        <div class="py-1">
                                                            <MenuItem v-slot="{ active }">
                                                                <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center']">
                                                                    <CheckIcon class="block h-4 w-4 mr-2" />
                                                                    Mark all read
                                                                </a>
                                                            </MenuItem>
                                                            <MenuItem v-slot="{ active }">
                                                                <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center']">
                                                                    <Cog6ToothIcon class="block h-4 w-4 mr-2" />
                                                                    Setting notifications
                                                                </a>
                                                            </MenuItem>
                                                            <MenuItem v-slot="{ active }">
                                                                <a href="#" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center']">
                                                                    <FolderOpenIcon class="block h-4 w-4 mr-2" />
                                                                    Open notifications
                                                                </a>
                                                            </MenuItem>
                                                        </div>
                                        ...
                                        <div class="flex items-center p-4">
                                            <img src="https://tailwindui.com/img/avatar-1.jpg" alt="" class="h-10 w-10 flex-none rounded-full">
                                            <div class="ml-4 flex-auto">
                                                <div class="font-medium">Leonard Krasner</div>
                                                <div class="mt-1 text-slate-700">@leonardkrasner</div>
                                            </div>
                                            <div class="pointer-events-auto cursor-pointer ml-4 flex-none rounded-md py-[0.3125rem]
                                                px-2 font-medium text-slate-700 shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50"
                                            >
                                                View
                                            </div>
                                        </div>
                                ...
                                <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75"
                                    ...
                                    <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                        <MenuItem v-slot="{ active }">
                                            <router-link
                                                :to="{name : 'profile.index'}"
                                                :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center']"
                                            >
                                                <UserIcon class="block h-4 w-4 mr-2" />
                                                Your Profile
                                            </router-link>
                                        </MenuItem>
                                        <MenuItem v-slot="{ active }">
                                        ...
                                        <MenuItem v-slot="{ active }">
                                            <a :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center cursor-pointer']">
                                                <ArrowRightOnRectangleIcon class="block h-4 w-4 mr-2" />
                                                Sign out
                                            </a>
                                        </MenuItem>
                                        <!-- Not Login  -->
                                        <MenuItem v-slot="{ active }">
                                            <a :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center cursor-pointer']">
                                                <ArrowLeftOnRectangleIcon class="block h-4 w-4 mr-2" />
                                                Sign in
                                            </a>
                                        </MenuItem>
                                        <MenuItem v-slot="{ active }">
                                            <a :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm flex items-center cursor-pointer']">
                                                <UserPlusIcon class="block h-4 w-4 mr-2" />
                                                Register
                                            </a>
                                        </MenuItem>
                                    </MenuItems>
            ...
            <DisclosurePanel class="md:hidden">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <DisclosureButton class="flex items-center rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">
                            <UserIcon class="block h-4 w-4 mr-2" />
                            Your Profile
                        </DisclosureButton>
                        <DisclosureButton class="flex items-center rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">
